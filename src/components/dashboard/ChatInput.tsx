...
export const ChatInput = forwardRef<HTMLDivElement, ChatInputProps>(({
  ...
  }, [inputMessage, selectedFile, isDisabled, isUploading, hasReachedLimit, creditsExhausted, onSend, triggerAttentionBlink, bumpActivity]);
